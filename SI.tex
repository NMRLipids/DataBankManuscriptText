...
\begin{figure}[hb]
    ...
    \caption{Predictions of area per lipids of POPC, POPE, POPS, PI, sphingomyelin lipids and cholesterol from the tested machine learning models against literature data from simulations (green~\cite{shahane19}, blue~\cite{kumar21}, and red~\cite{oliveira22}).}
    \label{fig:MLTest}
\end{figure}

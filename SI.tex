...
\begin{figure}
    \centering
    \includegraphics[width = 110mm]{Figures/totalrankingCOMPL.pdf}
...
\begin{table}[!h]
    ...
    \begin{tabular}{p{3.5cm}  p{4.5cm}  p{3.0cm}  p{4.0cm}}
        ...
        plotFlipFlop.ipynb & Plots how flip-flop rates depend on membrane properties & README.yaml and flipflop.dat files at {\it /Data/Flipflops/}. & Fig.~\ref{fig:flip-flops} \\
        ...
        plotWaterPermeation.ipynb & Plots how water permeation and diffusion depends on membrane properties. & README.yaml, Counting\_events.txt\,at {\it /Data/MD-PERMEATION/} and\,WATERlateralMSD.xvg files\,at {\it /Data/WATERdiffusion/} & Figs.~\ref{fig:permeability},~\ref{fig:permeationSI}, and~\ref{fig:diffusionSI}. \\
...
\begin{figure}
    ...
    \caption{Determination of DOPC order parameters from a R-PDLF spectrum measured at a magic angle spinning frequency of 5.15 kHz. (A) $^{13}$C rINEPT spectrum with peak assignment. The labels used are shown in the chemical structure of DOPC. The chemical shift of the methyl groups was defined as 13.8 ppm. (B) Contour plot of the R-PDLF spectrum for the crowded spectral region. The assignment was based on a previous assignment reported for POPC membranes~\cite{ferreira13}. (C) C-H order parameters of DOPC.}
    \label{fig:DOPCexp}
\end{figure}

\begin{figure}[p]
  \includegraphics[width=\textwidth]{Figures/DOPC_slices.pdf}
  \caption{Dipolar spectra obtained from the 2D R-PDLF spectrum described in Fig.~\ref{fig:DOPCexp}. The number at the top left of each plot denotes the corresponding chemical shift. The carbon label for each splitting is displayed on the top right. The labels are the same as in Fig.~\ref{fig:DOPCexp}. }
  \label{DOPCexp2}
\end{figure}

...
Acyl chain order parameters of POPE and POPG were analyzed from the experiments that were used to determine headgroup order parameters in Ref.~\citenum{bacle21}.

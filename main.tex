...
\begin{figure}[t]
    ...
    C) Area per lipids of POPC and POPE lipid bilayers predicted by different force fields.  
    }
...
This can be used to select the the simulations that best caputer area per lipids for POPE and POPC lipids in Fig.~\ref{fig:POPCPOPEapls}B because the area per lipid correlates with the average order parameter of the $\textit{sn}$-1 chain (Fig.~\ref{fig:quality} F).

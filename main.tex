...
All codes used in this study are available via git repositories \url{https://github.com/NMRlipids/Databank/} (DOI: 10.5281/zenodo.7875567) and \url{https://github.com/NMRLipids/DataBankManuscript/} (DOI: 10.5281/zenodo.10252380).
...
\noindent
\textbf{Figure 1.} Overview of the NMRlipids Databank. 
...
\textbf{Figure 2.} Examples of data obtained using NMRlipids Databank. 
    ...
    \noindent
\textbf{Figure 3.}
Predictions of areas per lipid of multi-component membranes composed of POPC, POPE, POPS, PI, sphingomyelin lipids, and cholesterol from linear regression model against literature data from simulations (green~\cite{shahane19}, blue~\cite{kumar21}, and red~\cite{oliveira22}). Black line indicates $x=y$.

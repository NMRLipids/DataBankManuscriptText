...
Using workflow depicted in Fig.~\ref{fig:POPCPOPEapls}D, we first calculated the cholesterol flip--flop rates from all the simulations available in the NMRlipids databank. Flip--flops were observed for cholesterol, % (634 events in 77 different simulations), 

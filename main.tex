...
\author[5]{Fernando Favela-Rosales}
...
\author[1,23,*]{O. H. Samuli Ollila} %ORCID: 0000-0002- 8728-1006
...
\affil[23]{VTT Technical Research Centre of Finland, Espoo, Finland}
...
We acknowledge all the NMRlipids project contributors for making the NMRlipids databank development possible.
...
L.S.B. implemented about 630 pre-existing lipid bilayer simulations into the databank and created corresponding mapping files.
...
B.K. contributed to the initial design and implementation of the databank and was involved with the writing the manuscript.
N.K. contributed experimental scattering data. % and SIMtoEXP algorithm.
P.K. Implemented the flip-flop analysis.
M.K. provided simulations with OPLS3e force field. 
A.K. implemented the PCA-based equilibration metric.
J.J.M. provided simulations with Amber force field, general discussion, and manuscript editing.
R.N. implemented the code for the calculations of X-ray scattering form factors.
T.P. Performed many of the all-atom and united-atom simulations and contributed to discussions on the project.
...
O.H.S.O. Designed and supervised the work, implemented water permeation and diffusion analyses, and wrote the manuscript. 
